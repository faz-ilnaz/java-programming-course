...
public class CVRepositoryTest {
    ...
    public void testFindByTitle() throws SQLException {
        ...
        //delete
        cvRepository.delete(newCV);
        assertNull(cvRepository.findOne(newCV.getId()));
    }
    ...
    public void testFindByOwner() throws SQLException {
        ...
        List<CV> cvList = cvRepository.findCVsByOwner(newCV.getOwner());
        assertNotNull(cvList);
        assertFalse(cvList.isEmpty());
        for(CV cv: cvList) {
            assertNotNull(cv);
